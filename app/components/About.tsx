      ...
      <Container>
        ...
        <div className="flex gap-16 py-6">
          ...
          <div className="flex flex-col gap-4 max-w-xl text-justify">
            <p>
              I`m a <span className="font-semibold">Software Engineer</span> based in Bandung,
            ...
            <p>
              Outside of work, I`m interested in following the developments of science. I also play a lot of video games. And make youtube videos.
            </p>
            <div>
